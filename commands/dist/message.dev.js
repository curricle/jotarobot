...
module.exports = function (client, message, args) {
  ...
  var msg = message.content.toLowerCase(); // List of dialogue options
  //hydration reminders
  ...
  var tys = ["thank you", "ty", "thx", "thank u", "thanks"]; //acceptable non-prefixed messages to react to
  ...
  if (message.content.indexOf(client.config.prefix) !== 0) return; //get message command
