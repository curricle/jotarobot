    ...
    execute(message) {
        ...
        */
        ...
        setTimeout(function() {
            ...
            var beginning = [
                `So... ${seconds} seconds, huh?`, 
                `${seconds} seconds...`, 
                `Managed to stop time for ${seconds} seconds.`
            ];
            var low = [
                "It's been a while.", 
                ...
                "Gonna be tough defeating DIO with this.", 
                "I'll never defeat DIO with this.", 
                "Damn."
            ];
            var mid = [
                "Not too shabby.", 
